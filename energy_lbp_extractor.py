...
def glcm_lbp_extraction(query_path, video_path, query_num, video_flag, cache):
    ...
    for i in range(query_num):
        ...
        features = extract_glcm_lbp_features(image)
    ...
    while True:
        ...
        for i in range(query_num):
            ...
            for frame_features in frame_features_list:
                contrast_similarity_t, energy_similarity_t, lbp_similarity_t = compare_glcm_lbp(query_features[i], frame_features)
                if contrast_similarity_min > contrast_similarity_t and energy_similarity_min > energy_similarity_t and lbp_similarity_min > lbp_similarity_t:
